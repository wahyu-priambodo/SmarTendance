...
user_ep.add_url_rule('/tutorial', endpoint="tutorial", view_func=tutorial, methods=['GET', 'POST'])
...
lecturer_ep.add_url_rule('/edit', endpoint="edit", view_func=lecturer_edit, methods=['GET', 'POST'])
lecturer_ep.add_url_rule('/view', endpoint="view", view_func=lecturer_view, methods=['GET'])
...
student_ep.add_url_rule('/dashboard', endpoint="dashboard", view_func=dashboard, methods=['GET', 'POST'])
