...
# edit student
admin_ep.add_url_rule('/<string:nim>/edit', endpoint="student_edit", view_func=edit_student, methods=['GET', 'POST'])
# edit lecturer
admin_ep.add_url_rule('/<string:nip>/edit', endpoint="lecturer_edit", view_func=edit_lecturer, methods=['GET', 'POST'])
...
lecturer_ep.add_url_rule('/logs', endpoint="student_recap", view_func=view_student_logs, methods=['GET'])