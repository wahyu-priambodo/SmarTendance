...
user_ep.add_url_rule(
    "/dashboard", endpoint="dashboard", view_func=dashboard, methods=["GET"]
)
...
admin_ep.add_url_rule(
    "/add/student",
    endpoint="add_student",
    view_func=add_student,
    methods=["GET", "POST"],
)
admin_ep.add_url_rule(
    "/add/lecturer",
    endpoint="add_lecturer",
    view_func=add_lecturer,
    methods=["GET", "POST"],
)
admin_ep.add_url_rule(
    "/add/course", endpoint="add_course", view_func=add_course, methods=["GET", "POST"]
)

# Action for view course
admin_ep.add_url_rule(
    "/courses/<string:class_id>/get",
    endpoint="get_courses",
    view_func=get_courses,
    methods=["GET"],
)
admin_ep.add_url_rule(
    "/courses", endpoint="courses", view_func=courses, methods=["GET"]
)

# Action for view class
admin_ep.add_url_rule(
    "/classes", endpoint="classes", view_func=classes, methods=["GET"]
)

# Action for attendance
admin_ep.add_url_rule(
    "/attendance",
    endpoint="view_attendance",
    view_func=view_attendance,
    methods=["GET"],
)
admin_ep.add_url_rule(
    "/attendance/<string:selected_role>/get",
    endpoint="get_attendance",
    view_func=get_attendance,
    methods=["GET"],
)
admin_ep.add_url_rule(
    "/attendance/<string:selected_role>/export",
    endpoint="export_attendance",
    view_func=export_attendance,
    methods=["GET"],
)
admin_ep.add_url_rule(
    "/attendance/<string:selected_role>/get_detail",
    endpoint="get_attendance_detail",
    view_func=get_attendance_detail,
    methods=["GET"],
)
admin_ep.add_url_rule(
    "/attendance/<string:selected_role>/detail",
    endpoint="view_attendance_detail",
    view_func=view_attendance_detail,
    methods=["GET"],
)
...
# edit lecturer
admin_ep.add_url_rule(
    "/<string:nip>/edit/lecturer",
    endpoint="edit_lecturer",
    view_func=edit_lecturer,
    methods=["GET", "POST"],
)
# edit course
admin_ep.add_url_rule(
    "/<string:course_id>/edit/course",
    endpoint="edit_course",
    view_func=edit_course,
    methods=["GET", "POST"],
)
...
# delete lecturer
admin_ep.add_url_rule(
    "/<string:nip>/delete/lecturer",
    endpoint="delete_lecturer",
    view_func=delete_lecturer,
    methods=["GET", "POST"],
)
# delete course
admin_ep.add_url_rule(
    "/<string:course_id>/delete/course",
